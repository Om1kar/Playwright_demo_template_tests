...
test.describe('Logged in should be successfull', () => {
...
test.describe('Upload pdf and send message', () => {

    test('Upload Pdf and start conversation', async ({ page }) => {
    ...
    test('Select uploaded pdf and start conversation', async ({ page }) => {

        await page.locator("//a[text()='AI PDF']").click();
        ...
        await page.waitForLoadState('networkidle')
        await page.getByPlaceholder('Ask question...').fill('What is linux?');
        await page.locator("button[type='submit']").click();
        await page.waitForTimeout(5000);
    });


    test.describe('Invite Member/Revoke Invitation of Invited Member ', () => {
